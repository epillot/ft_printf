...
/*   Updated: 2016/12/21 18:15:49 by epillot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char		*string_format(const char **s, t_option *st, va_list ap, int *size)
{
	char	*str;
	...
	else if (st->id == '%' || (st->id == 'c' && st->length.l == 0))
