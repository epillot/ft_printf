...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/12/21 16:17:46 by epillot           #+#    #+#             */
/*   Updated: 2016/12/21 18:22:13 by epillot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	get_itoa_size(uintmax_t n, int size_n, t_option st)
{
	int size;
...
static int	apply_option(uintmax_t n, char *s, t_option st, t_size size)
{
	...
	j = (st.id == 'p' || (is_hexa_conv(st) && st.flag.conv == 1 && n != 0) ? 2 : 0);
